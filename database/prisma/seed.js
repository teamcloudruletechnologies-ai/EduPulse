...
async function main() {
  console.log('🌱 Starting Database Seeding for EdTech Platform (JavaScript)...');
  ...
  const project = await prisma.project.create({
    data: {
      ...
      techStack: 'React, JavaScript, Node.js, Express, Python FastAPI, PostgreSQL, Tailwind CSS',
  ...
  console.log('✅ Database Seeding Complete (JavaScript)!');
  console.log('----------------------------------------------------');
