...
export const getLinkedChildren = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const linkChildAccount = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const parentId = req.user?.parentId;
...
export const getChildWeeklyReport = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
